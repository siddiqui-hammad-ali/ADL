    ...
    <>
      ...
      >
            ...
            {slider.map((sliders) => (
              <Carousel.Item>
                <div
                  className='bg-img'
                  style={{
                    backgroundImage: `url('${sliders.img}')`,
                    height: '100vh',
                  }}
                ></div>
              </Carousel.Item>
        ...
        <img
          ...
          style={{ height: '100vh', zIndex: 1, opacity: 0.7, top: 0 }}
          src='/adlpicture/overlay.png'
          alt='overlay'
        />
        <div className='himageText'>
          <p className='europe '>EUROPE &nbsp; / &nbsp; MIDDLEAST </p>
        </div>
        <div className='hlogo1'>
          <img width={'100%'} src={logo} />
        </div>
        <div className='harchitecture'>
          <p className='brandsName'>DESIGN / BUILD</p>
        </div>
        <div className='col-8 d-flex justify-content-end flex-wrap harchitecture1'>
          <p className='contact-detail'>
            <a
              href='mailto:info@anastomosisdesignlab'
          ...
          {/* className='ms-md-4 .d-sm-none .d-md-block .d-none .d-sm-block' */}
          <div>
            <p className='contact-detail'>
              <a
                href='https://twitter.com/anastomosisdl?s=20'
                target={'_blank'}
                style={{ textDecoration: 'none', color: 'inherit' }}
                rel='noreferrer'
              >
              ...
              <a
                href='https://www.instagram.com/adl_ksa/'
                target={'_blank'}
                style={{ textDecoration: 'none', color: 'inherit' }}
                rel='noreferrer'
              >
...
// {/* <div
//   className="btn-scroll d-sm-none d-md-block d-none d-sm-block "
//   style={{
//     position: "absolute",
//     bottom: "0",
//     right: "-18%",
